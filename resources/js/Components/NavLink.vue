...
const classes = computed(() =>
    props.active
        ? 'inline-flex items-center px-1 pt-1 border-b-2 border-brand-500 text-sm font-medium leading-5 text-slate-900 focus:outline-none focus:border-brand-700 transition duration-150 ease-in-out'

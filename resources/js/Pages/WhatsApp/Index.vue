            ...
            <div v-for="account in accounts" :key="account.id" class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-slate-900/5">
                <div class="flex items-start justify-between">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <Link v-if="account.phone_number_id" :href="route('whatsapp.billing', account.id)" class="inline-flex items-center gap-1.5 rounded-lg border border-emerald-300 bg-white px-3 py-1.5 text-sm font-semibold text-emerald-700 hover:bg-emerald-50 transition">
